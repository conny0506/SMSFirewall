...
// Version 3 yaptık, TrashMessage eklendi
@Database(entities = [BlockedWord::class, SpamMessage::class, TrashMessage::class], version = 3, exportSchema = false)
abstract class AppDatabase : RoomDatabase() {

    abstract fun blockedWordDao(): BlockedWordDao
    abstract fun spamMessageDao(): SpamMessageDao
    abstract fun trashMessageDao(): TrashMessageDao // YENİ EKLENDİ
